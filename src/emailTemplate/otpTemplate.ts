export const OTP_SUBJECT = ` Welcome to Satyug - Your one time password`;
        ...
        <tbody>
            <tr>
                <td class="logo-outer"
                    ...
                    <img class="logo" src="https://satyug-bucket.s3.amazonaws.com/email/satyug.png"
                        ...
                        <tbody>
                            <tr>
                                <td class="stats-heading"
                                    ...
                                    <h1 style="font-size: 32px; font-weight: 400;color: #FEC045;margin: 0;">सतयुग की
                                        दुनिया में आपका स्वागत है!!</h1>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td
                                    ...
                                    <p style="font-size: 16px; font-weight: 400;color: #FFF;margin: 0;">Please don't share your OTP anyone.</p>
                                </td>
                            </tr>
                ...
                <td class="footer" style="background-color: #313131; padding: 30px 60px;">
                    <table style="width: 100%; margin: 0 auto;">
                        ...
                        <td class="footer_cell"
                            ...
                            <a href="https://www.facebook.com/SatyugLabs/" style="display: inline-block;margin-right:  27px;" target="_blank"><img
                                src="https://satyug-bucket.s3.amazonaws.com/email/facebook%20logo.png"
                                style="width:  20px;height:  20px;" alt=""></a>
                        <a href="https://twitter.com/SatyugLife" style="display: inline-block;margin-right:  27px;" target="_blank"><img
                                src="https://satyug-bucket.s3.amazonaws.com/email/twitter logo.png" style="width:  20px;height:  20px;" alt=""></a>
                        <a href="https://discord.gg/3JJMfCag8A" style="display: inline-block;margin-right:  27px;" target="_blank"><img
                                src="https://satyug-bucket.s3.amazonaws.com/email/discordicon.png" style="width:  20px;height:  20px;" alt=""></a>
                        <a href="https://github.com/Satyug-life/Satyug-website" style="display: inline-block;margin-right:  27px;" target="_blank"><img
                                src="https://satyug-bucket.s3.amazonaws.com/email/githubicon.png" style="width:  20px;height:  20px;" alt=""></a>
                        <a href="https://www.reddit.com/r/satyug/" style="display: inline-block;margin-right:  27px;" target="_blank"><img
                                src="https://satyug-bucket.s3.amazonaws.com/email/reddit-solid.png" style="width:  20px;height:  20px;" alt=""></a>
                        <a href="https://t.me/+h5ablpKtH39mYzg1" style="display: inline-block;margin-right:  27px;" target="_blank"><img
                                src="https://satyug-bucket.s3.amazonaws.com/email/telegramicon.png" style="width:  20px;height:  20px;" alt=""></a>
